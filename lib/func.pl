...
print "\t<TR${tbc[6]}><TD><A HREF=\"#search_share\">サーチエンジンのシェア</A></TD><TD><A HREF=\"#search_key\">サーチエンジン分析</A></TD><TD>　</TD><TD>　</TD><TD>　</TD><TD>　</TD></TR>\n";
}
...
### メニュー/ブラウザ系
sub menu_ua { print "\t<TR${tbc[6]}><TD><A HREF=\"#ua\">ブラウザ統計</A></TD><TD><A HREF=\"#share_ie\">IE同士のシェア</A></TD><TD><A HREF=\"#share_os\">利用OS統計</A></TD><TD><A HREF=\"#share_nn\">　</A></TD><TD>　</TD><TD>　</TD></TR>\n"; }
