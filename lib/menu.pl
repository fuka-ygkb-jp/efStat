...
<CENTER><TABLE border=\"1\" cellpadding=\"2\" cellspacing=\"0\"><TBODY><TR>
		...
		<TD${tbc[7]}><INPUT type=\"radio\" name=\"MODE\" value=\"all\">全て表示</TD>
		<TD${tbc[8]}>　</TD>
	</TR><TR>
...
<CENTER><TABLE border=\"0\" cellpadding=\"4\" cellspacing=\"0\"><TBODY><TR><TD valign=\"top\">
	<TABLE border=\"1\" cellpadding=\"1\" cellspacing=\"0\"><TBODY><TR>
			<TH colspan=\"3\"${tbc[0]}>表示リミッタ (半角数字で指定)</TH>
		</TR><TR${tbc[5]}>
			<TH${tbc[1]}>表示範囲指定</TH>
...
print <<"_END_";
	...
	<BR><BR>
	<CENTER>
		<INPUT type=\"submit\" value=\"以上の条件でログを表示\"><BR><BR>
		結果の表示には時間がかかります。<BR>
		ボタンを押した後<BR>
		しばらくそのままでお待ち下さい。
	</CENTER>
